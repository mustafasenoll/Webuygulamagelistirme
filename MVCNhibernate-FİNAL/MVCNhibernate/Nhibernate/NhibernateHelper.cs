...
namespace MVCNhibernate.Nhibernate
{
    public class NhibernateHelper
    {
        ...
        private static ISessionFactory SessionFactory
        {
            get
            {
                if (_sessionFactory == null)
                {
                    ...
                    configuration.AddDeserializedMapping(mapping, "proje");
        ...
        public static Configuration ConfigureNhibernate()
        {
            ...
            configure.DataBaseIntegration(db =>
            {
                ...
                db.ConnectionString = "Server=localhost;Database=proje;Trusted_Connection=True;Data Source=.\\sqlexpress";
        ...
        protected static HbmMapping GetMappings()
        {
            ...
            mapper.AddMapping<Models.GörevlilerMap>();
